...
export default function SignUpPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.error) {
        toast.error(result.error.message || "Impossible de créer le compte.");
        return;
      }
        ...
        <div className="grid w-full items-center gap-12 lg:grid-cols-2">
          <div className="hidden lg:block">
            ...
            <h1 className="mt-8 max-w-xl text-5xl font-black leading-tight tracking-tight">
              Créez votre compte et commencez à suivre vos investissements.
            </h1>

            <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">
              Accédez à votre tableau de bord, suivez vos positions, analysez vos
              performances et prenez de meilleures décisions avec InvestX.
            </p>

            <div className="mt-10 grid max-w-md grid-cols-2 gap-4">
              <InfoCard title="Portfolio" text="Suivi clair" />
              <InfoCard title="Analytics" text="Performance" />
              <InfoCard title="Marchés" text="Données live" />
              <InfoCard title="Alertes" text="Prix ciblés" />
            </div>
          </div>
          ...
          >
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-5 text-3xl font-black">Créer un compte</h2>
              <p className="mt-2 text-sm text-slate-400">
                Rejoignez InvestX et accédez à votre espace investisseur.
              </p>
            </div>
